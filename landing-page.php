				...
				<div class="col-12">
					<nav class="main-nav">
						...
						<a href="index.html" class="logo">
							<b style="color: #ff6666;">SURYA</b>_IND
						</a>
						<!-- End Logo -->
						<!-- Menu Start -->
						<ul class="nav">
			...
			<div class="container">
				<div class="row">
					<div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
						<h1>Selamat Datang <em> Para Undangan</em></h1>
						<p><a href="#"> </a> Merupakan penyedia layanan yang memberikan pelayanan berupa jasa rekapitulasi tamu undangan yang datang pada suatu rapat, converence, maupun undangan formal lainnya.<b></b>.</p>
